...
unset($__errorArgs, $__bag); ?>"
                                                name="motivasi" value="<?php echo e(old('motivasi')); ?>" placeholder="Motivasi" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row mb-5">
                                    <div class="col-md-4 d-flex justify-content-start">Melunasi semua pembayaran uang
                                        sekolah dan uang makan sebelum Ujian Semester Ganjil dan Semester Genap.</div>
                                    <div class="col-md-2 d-flex justify-content-center">
                                        <div class="form-check">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\IDE\laragon\www\ppdb_smp\resources\views/siswa/create.blade.php ENDPATH**/ ?>