...
<?php $__env->startSection('container'); ?>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <h3>Registrasi Ulang File</h3>
                <table class="table table-striped mb-5">
                    <tbody>
                        <tr>
                            <th>Ijazah</th>
                            <td><a href="<?php echo e(asset('storage/public/uploads/'. $data['ijazah'] )); ?>" download>Link to: <?php echo e($user->registrasi_ulang->ijazah); ?></a></td>
                        </tr>
                        <tr>
                            <th>Surat Pernyataan Bermaterai</th>
                            <td>
                                <a href="<?php echo e(asset('storage/public/uploads/'. $data['surat_pernyataan_bermaterai'])); ?>" download>Link to: <?php echo e($user->registrasi_ulang->surat_pernyataan_bermaterai); ?></a>
                            </td>
                        </tr>
                        <tr>
                            <th>Surat Keterangan Siswa Aktif SD Asal</th>
                            <td>
                                <a href="<?php echo e(asset('storage/public/uploads/'. $data['surat_keterangan_siswa_aktif_sd_asal'])); ?>" download>Link to: <?php echo e($user->registrasi_ulang->surat_keterangan_siswa_aktif_sd_asal); ?></a>
                        ...
                        <tr>
                            <th>Pasfoto</th>
                            <td>
                                <a href="<?php echo e(asset('storage/public/uploads/'. $data['pasfoto'])); ?>" download>Link to: <?php echo e($user->registrasi_ulang->pasfoto); ?></a>
                            </td>
                        </tr>
                        <tr>
                            <th>Akta Kelahiran</th>
                            <td>
                                <a href="<?php echo e(asset('storage/public/uploads/'. $data['akta_kelahiran'])); ?>" download>Link to: <?php echo e($user->registrasi_ulang->akta_kelahiran); ?></a>
                            </td>
                        </tr>
                        <tr>
                            <th>Kartu Keluarga</th>
                            <td>
                                <a href="<?php echo e(asset('storage/public/uploads/'. $data['kk'])); ?>" download>Link to: <?php echo e($user->registrasi_ulang->kk); ?></a>
                            </td>
                        </tr>
                        <!-- Add more rows for other additional information -->
                    </tbody>
            ...
            <div class="row">
                <div class="col">
                    <a href="<?php echo e(asset('storage/app/'. url()->previous())); ?>" class="btn btn-danger btn-block">Back</a>
                </div>
            </div>
        </div>
    </div>
