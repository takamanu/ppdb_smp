  ...
  <body>
    ...
    <form class="row g-3" action="<?php echo e(route('payment.store')); ?>" method="post">
        ...
        <div class="col-auto">
          ...
          <input type="text" name="name" class="form-control" id="inputPassword2" placeholder="Nama">
        </div>
        <div class="col-auto">
...
</html><?php /**PATH C:\Users\LENOVO\OneDrive\Desktop\ppdb_smp\resources\views/midtrans.blade.php ENDPATH**/ ?>