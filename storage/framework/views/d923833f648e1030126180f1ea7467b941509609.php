        ...
        <div class="container mb-5">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Link WhatsApp</td>
                        <td colspan="2"><input type="name" id="redirect_wa" name="redirect_wa" aria-label="redirect_wa" class="form-control" value="<?php echo e($config->redirect_wa); ?>"></td>
                        ...
                        <td>
                            <div class="form-check">
                                <input class="form-check-input" type="radio"
                                    ...
                                    <?php echo e(old('pengumuman') == '0' ? 'checked' : ''); ?>>
                            ...
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio"
                                        ...
                                        <?php echo e(old('pengumuman') == '1' ? 'checked' : ''); ?>>
                    ...
                    <tr>
                        ...
                        <td colspan="2"><input type="name" id="nominal_pembayaran" name="nominal_pembayaran" aria-label="nominal_pembayaran" class="form-control" value="<?php echo e($config->nominal_pembayaran); ?>"></td>
