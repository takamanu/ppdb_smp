    ...
    <div class="card p-5">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                                ...
                                <td>
                                    ...
                                    @else
                                        <a href="{{ url('/agen/nilai/' . $item->id) }}"
                                            title="Tambah Kelulusan Siswa"><button class="btn btn-success btn-sm"><i
                ...
                <div class="row">
                    <a href="/excel/sudah-bayar" class="btn btn-success btn-block">Daftar siswa Sudah bayar (Download
                        XLSX)</a>
                    <a href="/excel/sudah-lulus" class="btn btn-success btn-block">Daftar siswa Sudah lulus (Download
                        XLSX)</a>
                    <a href="/excel/tidak-lulus" class="btn btn-success btn-block">Daftar siswa Tidak lulus (Download
                        XLSX)</a>
                </div>
            </div>
        </div>
